package br.com.qualitylife.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors
						.basePackage("br.com.qualitylife.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
				.title("API - Projeto Integrador Quality Life")
				.description("Projeto API Spring - Quality Life")
				.version("1.0.0")
				.license("Apache License Version 2.0")
				.licenseUrl("https://github.com/genQualityLife")
				.contact(contact())
				.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Quality Life",
				"https://github.com/genQualityLife", 
				"gen.qualitylife@gmail.com");
	}
